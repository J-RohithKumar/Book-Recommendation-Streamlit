...
book_with_ratings = load_pickle_file("./book_with_ratings.pkl")
similarity_scores = load_pickle_file("similarity_scores.pkl")
books = load_pickle_file("books.pkl")
ratings = load_pickle_file("ratings.pkl")
users = load_pickle_file("users.pkl")
top50_popular_books = load_pickle_file("./top50_popular_df.pkl")
...
if st.sidebar.button('Show'):
    ...
    print(top50_popular_books)

# Collaborative Based Recommendation

def recommend_book(book_name):
  similar_books=similarity_scores[book_name].sort_values(ascending=False)[1:11].index
